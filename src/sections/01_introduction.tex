...
\begin{theorem}[Multifold sums of odd powers in central differences]
  ...
  \begin{mdframed}
    For positive integers $n,m$ and $r\geq0$
    \begin{align*}
...
theorem~\eqref{theorem:multifold-sums-of-odd-powers}
...
the theorem~\eqref{theorem:multifold-sums-of-odd-powers} utilizes
central differences explicitly,
because
...
are registered as \href{https://oeis.org/A008957}{\texttt{A008957}}
