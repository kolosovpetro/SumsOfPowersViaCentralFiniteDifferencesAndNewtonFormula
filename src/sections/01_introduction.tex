...
and Newton's series is quite generic. Formulas for sums
of powers using forward and backward differences
can be found in
...
\end{align*}
Thus, for odd powers, only even differences contribute.
...
Meaning that the Knuth's formula for sums of odd powers
...
yields
\begin{corollary}[Central binomial re-factorization]
  \label{cor:central-binomial-refactorization}
  ...
  \end{align*}
  \begin{proof}
    By binomial decomposition~\eqref{prop:binomial-refactorization} yields
    \begin{align*}
      j \tbinom{j-t+\frac{k}{2} -1}{k-1}
      &=
...
\begin{align*}
  ...
  + \frac{k}{2}
  \left( \binom{n-t+\frac{k}{2}}{k} - \binom{-t+\frac{k}{2}}{k} \right) \\
  &=k \left( \binom{a}{k+1} - \binom{a-n}{k+1} \right)
  + \frac{k}{2}
...
\begin{proposition}[Simplified centered sums of powers]
  ...
  \begin{mdframed}
    ...
    \begin{align*}
      \KnuthRFoldSum{1}{n}{m}
      = \sum_{j=1}^{n} t^m + \sum_{k=1}^{m} \frac{\delta^{k} t^m}{2}
      \left[
...
For instance, for $r=2$ sums of powers, we have
\begin{align*}
  &\KnuthRFoldSum{2}{n}{m}
...
\begin{proposition}[Multifold sum of zero powers]
  ...
  \begin{proof}
    \begin{enumerate}
      \item Let be $r=0$, then $\KnuthRFoldSum{0}{n}{0}=n^0=\binom{n-1}{0} = 1$,
        by definition~\eqref{prop:multifold-sums-of-powers-recurrence}.
      \item Let be $r=1$, then
        $\KnuthRFoldSum{1}{n}{0} = \sum_{k=1}^{n} \binom{k-1}{0} = \sum_{k=1}^{n} 1 = \binom{n}{1}$.
      \item Let be $r=2$, then
        $\KnuthRFoldSum{2}{n}{0}= \sum_{k=1}^{n} \binom{k}{1} = \sum_{k=1}^{n} k = \binom{n+1}{2}$.
      \item Let be $r=3$, then $\KnuthRFoldSum{3}{n}{0}= \sum_{k=1}^{n} \binom{k+1}{2}
        = \binom{n+2}{3}$.
  ...
  \end{proof}
\end{proposition}
Thus, binomial form of multifold centered
sums of powers~\eqref{theorem:multifold-centered-sums-of-powers}
follows
