...
factorials~\eqref{prop:binomial-form-of-central-factorials},
we have for $k \geq 1$
\begin{align*}
  \frac{\centralFactorial{(n-t)}{k}}{k!}
  = \frac{n-t}{k} \binom{n-t+\frac{k}{2}-1}{k-1}
\end{align*}
Thus,
...
\end{align*}
Thus, ordinary sum of powers is
\begin{align*}
  \KnuthRFoldSum{1}{n}{m}
  = t^m + \sum_{k=1}^{m} \frac{\delta^{k} t^m}{k}
