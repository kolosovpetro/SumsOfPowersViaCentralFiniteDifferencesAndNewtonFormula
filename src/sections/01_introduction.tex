...
\begin{lemma}[Central factorial]
    ...
    \end{align*}
\end{lemma}
We observe that central factorials are closely related to falling factorials $\fallingFactorial{x}{n} = x(x-1)(x-2)(x-3)\cdots(x-n+1)$.
Therefore,
\begin{align*}
...
\begin{proposition} [Newton's series for power in zero]
    \begin{align*}
        n^{m} = \sum_{k=0}^{m} \frac{1}{k+1} \binom{n+\frac{k+1}{2}-1}{k} \delta^{k+1} 0^{m+1}
    \end{align*}
\end{proposition}
Thus, formula for ordinary sums of powers follows
\begin{proposition} [Ordinary sums of powers]
    \begin{align*}
        \KnuthRFoldSum{1}{n}{m} = \sum_{k=0}^{m} \frac{1}{k+1} \binom{n+\frac{k+1}{2}}{k+1} \delta^{k+1} 0^{m+1}
    \end{align*}
    \begin{proof}
        We have
