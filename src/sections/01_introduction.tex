...
\begin{proposition}[Central factorial]
  \begin{align*}
    \centralFactorial{n}{k} =
    \begin{cases}
      1, \quad & \mathrm{if \; } k=0 \\
      n \left( n + \frac{k}{2} -1 \right)\left( n + \frac{k}{2} -2 \right) \cdots \left( n - \frac{k}{2} +1 \right) = n \prod_{j=1}^{k-1} \left( n + \frac{k}{2} -j \right), \quad & \mathrm{if \; } k>0
    \end{cases}
  \end{align*}
\end{proposition}
