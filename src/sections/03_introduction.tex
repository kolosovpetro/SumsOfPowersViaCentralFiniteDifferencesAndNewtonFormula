...
% backward Newton's interpolation formula for powers
% \eqref{lem:backward-newtons-formula-for-powers}
% with hockey-stick identity
% \eqref{lem:backward-hockey-stick-identity}.
...
% by utilizing backward Newton's formula, and hockey-stick
% identity~\eqref{lem:backward-hockey-stick-identity}.
