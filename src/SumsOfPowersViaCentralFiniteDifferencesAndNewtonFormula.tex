...
%    \tableofcontents
    ...
    \input{sections/02_proof_of_knuth_formula}


    \section{Sums of powers in Stirling and Eulerian numbers}
    \label{sec:sums-of-powers-in-terms-of-stirling-and-eulerian-numbers}
    \input{sections/03_sums_of_powers_in_strigling_and_eulerian_numbers}
